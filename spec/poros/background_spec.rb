...
RSpec.describe Background do
  it 'exists and has readable attributes', :vcr do
    ...
    expect(background.image_url).to eq("https://images.unsplash.com/photo-1642980364256-12e2811c91ae?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMzY4Njd8MHwxfHNlYXJjaHwxfHxtaWFtaSUyQ2ZsfGVufDB8fHx8MTY1NTA3NjE1NQ&ixlib=rb-1.2.1&q=80")
